...
```
cd existing_repo
git remote add origin https://git.sogyo.nl/ffluit/schaak-frank.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.sogyo.nl/ffluit/schaak-frank/-/settings/integrations)
