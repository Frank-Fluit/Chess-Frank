            ...
            <div className="absolute2 bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed bg-black/60">
                <div className="flex h-full items-center justify-center">
                    <div className="text-white">
                        <h2 className="mb-4 text-4xl font-semibold">IP Frank Fluit Schaak</h2>
                        <h4 className="mb-6 text-xl font-semibold">Vul de namen van de spelers in die gaan schaken</h4>
