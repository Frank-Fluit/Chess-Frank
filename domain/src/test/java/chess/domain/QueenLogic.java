...
public class QueenLogic {
    ...
    String diagonalTestBoard = "EEEEEEEK" +
            "QQQQQQQQ" +
            "EEEEEEEE" +
            "EEEEEEEE" +
            "EEEEEEEE" +
...
// One of these moves creates a check
    ...
    public void TestIfSingleBlackMoveIsAllowed(int num){
        Board chessBoard = new Board(queenBoard);
        King whiteKing = (King)chessBoard.getSquares(0,7).getPiece();
        whiteKing.startAMove(0,6);
    ...
    @ParameterizedTest
    @ValueSource(ints = {0,2,3,4,5,6,7})
